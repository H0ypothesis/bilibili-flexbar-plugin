...
在 FlexBar 上显示哔哩哔哩**正在播放**的视频（封面 / 标题 / UP主 / 进度）与**实时字幕**，并直接控制
**进度条拖拽、播放/暂停、下一集、快进快退、音量、弹幕、点赞/投币/收藏、全屏**。
...
| --- | --- |
| 视频标题 / UP主 / 封面 / 进度显示 | ✅ |
| **字幕显示**（实时，支持双语） | ✅ 主粉色大字 + 副白色小字，需视频开字幕 |
...
| **全屏 打开 / 关闭**（multiState 按键） | ✅ 全屏时高亮，跟随 Esc/鼠标退出 |
| 触感反馈（haptic） | ✅ 离散操作时 |
...
| 字幕 | default | 显示当前字幕行；双语时主字幕粉色大字、副字幕白色小字，建议放宽一些 |
...
| 全屏 | **multiState** | 打开 / 关闭全屏，全屏时高亮 |

> 点赞可直接切换；投币、收藏会按哔哩哔哩客户端的设置走——在 B 站里开启「投币后不再询问」即可一键投币。
>
> 字幕来自播放器渲染的当前行，需在播放器里**打开字幕**；有无字幕（及是否双语）取决于该视频是否提供。
